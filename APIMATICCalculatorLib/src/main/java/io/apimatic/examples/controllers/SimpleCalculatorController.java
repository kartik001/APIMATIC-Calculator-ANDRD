...
public class SimpleCalculatorController extends BaseController {
    ...
    public void getCalculateAsync(
        ...
        APIHelper.appendUrlWithTemplateParameters(queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4830850433788915597L;
            {
        ...
        APIHelper.appendUrlWithQueryParameters(queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5151990039677240052L;
            {
                    put( "x", input.getX() );
                    put( "y", input.getY() );
            }});
        ...
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4865683227073623954L;
            {
